...
/**
 * Skin of the ring progress indicator where an arc grows by the progress value up to 100% where the arc becomes a ring.
...
public class RingProgressIndicatorSkin implements Skin<RingProgressIndicator> {
    ...
    /**
     * Constructor class for indicator skin.
     * @param indicator
     */
