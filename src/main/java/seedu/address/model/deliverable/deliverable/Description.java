...
public class Description {
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
            || (other instanceof seedu.address.model.deliverable.deliverable.Description // instanceof handles nulls
            && value.equals(((seedu.address.model.deliverable.deliverable.Description) other).value)); // state check
    }
