...
public class SampleDataUtil {
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Person(new Name("Bonny Thompson"), new Phone("1234444"), new Email("thompson@example.com"),
                    Role.getRole("stk"), new Description("Business Associate")),
    ...
    public static Deliverable[] getSampleDeliverables() {
        return new Deliverable[] {
            ...
            new Deliverable(new Title("Finalize design and plan"), new Milestone("1.4"),
                new Description("Get approval from Head of Engineering and Head of Business."),
            ...
            new Deliverable(new Title("Refine design and plan"), new Milestone("2.5"),
                new Description("Discuss design and plan with Product Designer and UI/UX team again."),
    ...
    public static Meeting[] getSampleMeetings() {
        return new Meeting[] {
            ...
            new Meeting(new Title("Check-in about MVP completion"), new Description("With tech lead"),
