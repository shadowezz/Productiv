...
public class ViewCommand extends Command {
    ...
    public static final String MESSAGE_VIEW_MEETING_SUCCESS = "Viewing meeting: %1$s";
    public static final String MESSAGE_USAGE = COMMAND_WORD
            + ": Views the details of the meeting identified by the index number used in the meeting list\n"
