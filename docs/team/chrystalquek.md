...
* **Major enhancement**: Update `Person` to `Contact` that is more useful for product-management.
  * What it does: allows the user to CRUD `Contact`s in Productiv.
  ...
  * Highlights: Refactored `Person` to `Contact`. A `Contact` can have a `Role` (developer or stakeholder) and also a `Description`. 
...
### Contributions to team-based tasks
  ...
  * Necessary general code enhancements
      ...
      * Update `Person` to `Contact` that is more useful for product-management: [\#37](https://github.com/AY2021S1-CS2103T-F11-2/tp/pull/37), [\#67](https://github.com/AY2021S1-CS2103T-F11-2/tp/pull/67)
...
### Community
  ...
  * Total PRs reviewed: 30+, Total comments given: 100+
...
### Documentation
  ...
  * Developer Guide:
    * Added implementation details of the `switch` feature. Included UML diagrams `SwitchModeSequenceDiagram` and `SwitchModeActivityDiagram`: [\#241](https://github.com/AY2021S1-CS2103T-F11-2/tp/pull/241)
