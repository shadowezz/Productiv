...
The *Sequence Diagram*s below show how the components interact with each other for the scenario where the user issues the command `delete 1`, applicable in the deliverable, meeting, or person mode.
